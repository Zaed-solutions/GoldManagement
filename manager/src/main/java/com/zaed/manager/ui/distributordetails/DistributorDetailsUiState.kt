...
data class DistributorDetailsUiState(
    ...
    val selectedSalesDateRange: Pair<Date?, Date?> = null to null,
    ...
    val filteredIngotTransactions: List<IngotTransaction> = emptyList(),
    ...
    val selectedIngotsRange: Pair<Date?, Date?> = null to null,
)
