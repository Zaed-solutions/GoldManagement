...
@Composable
fun DistributorSalesFilterBottomSheet(
    modifier: Modifier = Modifier,
    isVisible: Boolean,
    onDismiss: () -> Unit,
    onSubmitFilter: (DistributorsSalesFilter) -> Unit,
    initialFilter: DistributorsSalesFilter,
                ...
                Column(
                    ...
                    AnimatedVisibility(employees.isNotEmpty()) {
                        Column {
                            TitledSection(
                                modifier = Modifier.padding(horizontal = 16.dp),
                                title = stringResource(R.string.distributors),
                                style = MaterialTheme.typography.titleLarge
                            ) {
                                FlowRow(
                                    modifier = Modifier.fillMaxWidth(),
                ...
                Row (
                    ...
                    FilledTonalButton(
                        modifier = Modifier
                            ...
                            .heightIn(min = 48.dp),
                        onClick = {
                            onSubmitFilter(DistributorsSalesFilter())
                        },
                        shape = MaterialTheme.shapes.medium
                    ) {
                        Text(
