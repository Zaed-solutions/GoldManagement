            ...
            drawerContent = {
                ModalDrawerSheet {
                    Row(
                        ...
                        Text(
                            text = stringResource(com.zaed.manager.R.string.app_name),
...
fun User.isApprovedManager(): Boolean {
    return this.role == UserRole.MANAGER && this.approvalStatusType == UserApprovalStatus.APPROVED
}